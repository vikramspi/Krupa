/**
 * Mumbai neighbourhoods, mirrored from the customer site (src/data/areas.ts there).
 * Keep both copies in sync when adding an area — vendors' coverage uses these ids.
 */
export interface ServiceArea {
  ...
  coverage: "supported" | "coming_soon";
}
