...
/**
 * Full-page navigation (not a client fetch): the server redirects to Google and
 * Google redirects back, so this must be a plain link.
 */
export function GoogleSignInButton({ next, label = "Continue with Google", className }: { next: string; label?: string; className?: string }) {
  return (
    <a
